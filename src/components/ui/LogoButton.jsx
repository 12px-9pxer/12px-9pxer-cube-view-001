...
export default function LogoButton() {
  ...
  return (
    <button
      ...
      className="absolute left-[clamp(20px,2.08vw,40px)] top-[7.13vh] z-20 flex w-[clamp(88px,8.6vw,165px)] origin-center items-start border-0 bg-transparent p-0 outline-none focus-visible:ring-2 focus-visible:ring-white/70"
